...
export default function SpaceQuestionDetailPage({
  ...
  /** Before paint: drop stale question from the previous route. Vote UI reads only `question.myVote` (no localStorage). */
  useLayoutEffect(() => {
    setQuestion(null);
    setMessage("");
  ...
  /** Single source of truth: API `myVote` on this question row only (never localStorage). */
            ...
            <header className="flex items-center gap-3 border-b border-zinc-800/80 px-4 py-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-zinc-500">
                  {formatQuestionAge(question.createdAt) ?? "Community question"}
                </p>
              </div>
            </header>
